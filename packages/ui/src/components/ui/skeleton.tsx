...
export function WorkspaceLayoutSkeleton() {
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background flex flex-col">
      {/* Sidebar Skeleton */}
      <header
        style={{ height: `${WINDOW_HEADER_HEIGHT}px` }}
        className="flex h-10 w-full shrink-0 items-center justify-between border-b border-border/50 bg-background/80 px-2"
      >
